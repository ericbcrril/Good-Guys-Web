        ...
        <main className="main-home">
                ...
                <div className="home-content1">
                        <div className="home-box-element">
                            <div className="link-wrapper" to="#" onClick={() => alert("Cursos en linea de distintas tecnologias, ¡Esperalo!")}>
                                <img src="/images/icons/online-education.webp" alt="logo"/> 
                                <p>Cursos Online</p>
                            </div>
                        </div>
                        <div className="home-box-element">
                            <div className="link-wrapper" to="#" onClick={() => alert("Encriptacion y Proteccion de datos, ¡Esperalo!")}>
                                <img src="/images/icons/cyber-security.webp" alt="logo" className="home-box-element-img"/> 
                                <p>Encriptacion y Ciberseguridad</p>
                            </div>
                        </div>
                        <div className="home-box-element">
                            <Link className="link-wrapper" to="/marketing">
                                <img src="/images/icons/bullhorn.webp" alt="logo"/> 
                                <p>Marketing</p>
                            </Link>
                        </div>
                        ...
                        <div className="home-box-element">
                            <Link className="link-wrapper" to="/desarrollo-movil">
                                <img src="/images/icons/mobile-development.webp" alt="logo"/> 
                                <p>Desarrollo Movil</p>
                            </Link>
                        </div>
                        <div className="home-box-element">
                            <Link className="link-wrapper" to="/desarrollo-web"> 
                                <img src="/images/icons/web-coding.webp" alt="logo"/> 
                                <p>Desarrollo Web</p>
                            </Link>
                        </div>
                        <div className="home-box-element">
                            <div className="link-wrapper" to="#" onClick={() => alert("Divertido Casino en linea, ¡Esperalo!")}> 
                                <img src="/images/icons/game.webp" alt="logo"/> 
